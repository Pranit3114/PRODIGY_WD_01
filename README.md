...
✨ Key Features
---
*Fixed Position Navbar* — stays visible at all times across all sections.  
*Scroll-Triggered Glassmorphism* — transparent at the top, transitions to a frosted-glass panel with blur/shadow after scrolling 60px.  
*Hover Animations* — each menu item lifts up, gains a gradient underline, and a subtle glow background on hover.  
